...
- **Wappalyzer fingerprint**: Sets `window.ngxNotitia` to the library version on initialization, enabling detection by Wappalyzer and similar technology scanners.
